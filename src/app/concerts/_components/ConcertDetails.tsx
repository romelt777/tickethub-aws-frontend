...
type ConcertDetailsType = {
    id: string,
    date: string,
}

//using concert info received from parent (id/page.tsx)
const ConcertDetails = ({ concert }: { concert: ConcertDetailsType }) => {
    //setting quantity to default value 1 
